...
import { ErrorDataSignNotification } from './error-data-sign-notification';
import { SuccessDataSignNotification } from './success-data-sign-notification';
                    ...
                    {openedNotification => (
                        <Switch>
                            ...
                            <Match when={openedNotification.action === 'data-signed'}>
                                <SuccessDataSignNotification class={NotificationClass} />
                            </Match>
                            <Match when={openedNotification.action === 'data-sign-canceled'}>
                                <ErrorDataSignNotification class={NotificationClass} />
                            </Match>
                            <Match
                                when={
