...
export class WalletsListManager {
    ...
    private readonly checkRequiredFeatures: undefined | ((features: Feature[]) => boolean);
    ...
    constructor(options?: {
        ...
        this.checkRequiredFeatures = options?.walletsRequiredFeatures
            ? features => checkRequiredWalletFeatures(features, options.walletsRequiredFeatures!)
            : undefined;
    }
    ...
    public async getWallets(): Promise<WalletInfo[]> {
        ...
        return this.walletsListCache.then(walletsList => {
            return this.checkRequiredFeatures
                ? walletsList.filter(
                      wallet => Boolean(wallet.features) && this.checkRequiredFeatures!(wallet.features!)
                  )
                : walletsList;
        });
    }
